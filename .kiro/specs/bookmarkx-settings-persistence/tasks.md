...
- [ ] 1. Fix wallpaper persistence - update saveSettings() and BackgroundUtils.init()
...
- [ ] 2. Fix accent color validation in theme.js
...
- [ ] 3. Fix storage synchronization - sync all legacy keys on save and load
